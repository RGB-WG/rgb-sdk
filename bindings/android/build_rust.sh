...
aarch64-linux-android21-clang++ -shared swig_wrap.cxx -L$RUSTLIB/target/aarch64-linux-android/release/ -lrgb -o $JNILIBS/arm64-v8a/librgb_node.so -fPIC
...
x86_64-linux-android21-clang++ -shared swig_wrap.cxx -L$RUSTLIB/target/x86_64-linux-android/release/ -lrgb -o $JNILIBS/x86_64/librgb_node.so -fPIC
...
armv7a-linux-androideabi21-clang++ -shared swig_wrap.cxx -L$RUSTLIB/target/armv7-linux-androideabi/release/ -lrgb -o $JNILIBS/armeabi-v7a/librgb_node.so -fPIC
...
i686-linux-android21-clang++ -shared swig_wrap.cxx -L$RUSTLIB/target/i686-linux-android/release/ -lrgb -o $JNILIBS/x86/librgb_node.so -fPIC
