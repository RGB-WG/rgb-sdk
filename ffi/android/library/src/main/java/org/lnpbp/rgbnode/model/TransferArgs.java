...
public class TransferArgs {
    ...
    public TransferArgs(List<String> inputs, List<IssueArgs.CoinAllocation> allocate, String invoice, String prototype_psbt, String consignment_file, String transaction_file) {
        this.inputs = inputs;
